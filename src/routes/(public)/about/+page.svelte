<script lang="ts">
    ...
    import nathanAvatar from '$assets/images/avatars/nathan.webp?enhanced';
        ...
        <div class="flex flex-wrap items-center justify-center gap-4">
            <Card padding="md" size="xs">
                <div class="flex flex-col items-center">
                    <enhanced:img src={tylerAvatar} alt="Thats meeeeeee" class="w-24 h-24 rounded-full m-4" />
                    <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Tyler Place</h5>
                    <span class="text-gray-500 dark:text-gray-400">Main Developer</span>
            ...
            <Card padding="md" size="xs">
                <div class="flex flex-col items-center">
                    <enhanced:img src={nathanAvatar} alt="Nathan" class="w-24 h-24 rounded-full m-4" />
