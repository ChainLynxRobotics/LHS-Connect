...
export const BellScheduleDefaults = SingleValueModel.discriminator(
	'BellScheduleDefaults',
	bellScheduleDefaultsSchema
); // There is only one document of this so we use the SingleValueModel as the base
