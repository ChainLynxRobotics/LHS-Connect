...
<form bind:this={form} on:submit={handleSubmit} method="post" novalidate class="flex flex-col space-y-6">
    ...
    <div class="flex items-start">
        ...
        <button type="button" on:click={()=>passwordInfoOpen = true} class="inline ms-auto text-sm text-primary-700 hover:underline dark:text-primary-500"> Forgot Password? </button>
    </div>
    <Button type="submit" class="w-full">Login to your account</Button>
    <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
        Not registered? <a href="/admin/register" class="text-primary-700 hover:underline dark:text-primary-500"> Create account </a>
    </div>
</form>
...
<Modal bind:open={passwordInfoOpen} size="xs" autoclose outsideclose>
    <div class="text-center">
        ...
        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Please contact the site owner to reset your password</h3>
